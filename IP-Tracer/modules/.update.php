...
function upd() {
  ...
  sleep(1);
  system("cd ~/ && git clone https://github.com/GHOSTs-OCTOPUS/Hack-With-Android/IP-Tracer.git");
  system("cd ~/ && sudo git clone https://github.com/GHOSTs-OCTOPUS/Hack-With-Android/IP-Tracer.git");
